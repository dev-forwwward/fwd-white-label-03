...
class PBAccordionFAQS {
  ...
  cleanupInitialState() {
    document.querySelectorAll('[pb-component="accordion-faqs"]').forEach(accordion => {
...
// Wrapped in DOMContentLoaded so DOM is ready when module is imported by main.js
